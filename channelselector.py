...
def getchanneltypes(preferred_thumb=""):
 ...
 #   itemlist.append( Item( title=config.get_localized_string(30121) , channel="channelselector" , action="listchannels" , category="*"   , thumbnail=urlparse.urljoin(get_thumbnail_path(preferred_thumb),"thumb_canales_todos.png")))
    ...
    itemlist.append( Item( title="Torrent" , channel="channelselector" , action="listchannels" , category="T" ))
    itemlist.append( Item( title="Film 3D" , channel="channelselector" , action="listchannels" , category="3" ))
...
def channels_list():
    ...
    #itemlist.append( Item( title="[COLOR azure]BreakingBadITA Streaming[/COLOR]"      , channel="breakingbadita"           , language="IT"    , category="S"   ))
    ...
    itemlist.append( Item( title="[COLOR azure][PRE-Release] Solo-Streaming[/COLOR]"      , channel="solostreaming"           , language="IT"    , category="B,F,S,A,VOS"   , type="generic"))
