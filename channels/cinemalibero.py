...
def mainlist(item):
    ...
    itemlist = [Item(channel=__channel__,
                ...
                Item(channel=__channel__,
                     ...
                     action="categorias",
                     url="http://www.cinemalibero.com/category/film/",
                     thumbnail="https://raw.githubusercontent.com/orione7/Pelis_images/master/General_Popular/most%20used/category.png"),
                Item(channel=__channel__,
...
def peliculas_tv(item):
    ...
    for scrapedurl, scrapedthumbnail, scrapedtitle in matches:
        ...
        try:
            plot, fanart, poster, extrameta = info_tv(tmdbtitle, year)
