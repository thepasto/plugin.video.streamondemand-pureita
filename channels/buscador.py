...
def do_search(item):
    ...
    logger.info("streamondemand-pureita-master.channels.buscador master_exclude_data_file=" + master_exclude_data_file)
    ...
    if os.path.exists(master_exclude_data_file):
        logger.info("streamondemand-pureita-master.channels.buscador Encontrado fichero exclusiones")

        fileexclude = open(master_exclude_data_file, "r")
        excluir = fileexclude.read()
        fileexclude.close()
    else:
        logger.info("streamondemand-pureita-master.channels.buscador No encontrado fichero exclusiones")
        excluir = "seriesly\nbuscador\ntengourl\n__init__"
